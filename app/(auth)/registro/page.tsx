  ...
  return (
    <main className="flex flex-1 items-center justify-center bg-[#f7f1e8] px-6 py-16">
      <section className="w-full max-w-md rounded-[2rem] bg-white p-8 shadow-sm ring-1 ring-black/5">
        ...
        <h1 className="mt-3 text-3xl font-semibold tracking-tight">Crear cuenta</h1>
        <p className="mt-2 text-sm text-zinc-600">
          Las cuentas públicas nacen como cliente. Los roles internos se asignan desde Supabase.
        </p>
        <div className="mt-8">
